        ...
        <section className="py-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl font-bold mb-6 neon-text-blue">Privacy Policy</h1>
              ...
              <div className="glass-card p-8 space-y-8">
                <div>
                  ...
                  <p className="text-gray-300">
                    At EduSphere AI, we take your privacy seriously. This Privacy Policy explains how we collect, use,
                ...
                <div>
                  ...
                  <p className="text-gray-300 mt-4">
                    This information may include your name, email address, educational institution, academic interests,
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    ...
                    in this privacy policy, unless a longer retention period is required or permitted by law. No purpose
                    in this policy will require us keeping your personal information for longer than the period of time
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    If you have any questions about this privacy policy, please contact us at privacy@edusphereai.com.
                  </p>
                </div>
