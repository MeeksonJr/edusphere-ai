...
export default function TermsPage() {
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Use License</h2>
      ...
      <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">User Accounts</h2>
      <p className="text-foreground/70 mb-4 leading-relaxed">
      ...
      <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">User Content</h2>
      <p className="text-foreground/70 mb-4 leading-relaxed">
      ...
      <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Prohibited Uses</h2>
      <p className="text-foreground/70 mb-4 leading-relaxed">
      ...
      <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Subscription and Payment</h2>
      <p className="text-foreground/70 mb-4 leading-relaxed">
      ...
      <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Cancellation and Refunds</h2>
      <p className="text-foreground/70 mb-6 leading-relaxed">
      ...
      <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Contact Information</h2>
      <p className="text-foreground/70 mb-6 leading-relaxed">
