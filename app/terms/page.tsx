        ...
        <section className="py-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl font-bold mb-6 neon-text-blue">Terms of Service</h1>
              <p className="text-xl text-gray-300 mb-8">Please read these terms carefully before using EduSphere AI.</p>
            </div>
          </div>
        </section>
              ...
              <div className="glass-card p-8 space-y-8">
                <div>
                  ...
                  <p className="text-gray-300">
                    Welcome to EduSphere AI ("we," "our," or "us"). By accessing or using our website, mobile
                    applications, or any of our services (collectively, the "Services"), you agree to be bound by these
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-4">
                    ...
                    from a parent or guardian to use our Services, and they must agree to these Terms on your behalf.
                  </p>
                  <p className="text-gray-300">
                    By using our Services, you represent and warrant that you meet all eligibility requirements. If you
                    are using the Services on behalf of an entity, organization, or company, you represent and warrant
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    We reserve the right to disable any user account at any time, including if we believe you have
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-4">
                    Some of our Services are offered on a subscription basis. By subscribing to our Services, you agree
                    to pay the applicable fees as they become due. All fees are exclusive of taxes, which may be added
                    to the fees charged to you.
                  </p>
                  <p className="text-gray-300 mb-4">
                    Subscriptions automatically renew for the same subscription term unless you cancel your subscription
                    before the end of the current term. You can cancel your subscription at any time through your
                    account settings or by contacting us.
                  </p>
                  <p className="text-gray-300">
                    We reserve the right to change our subscription fees at any time. If we change our fees, we will
                    provide notice of the change on the website or by email, at our discretion. Your continued use of
                    the Services after the fee change becomes effective constitutes your agreement to pay the updated
                    fees.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-4">
                    Our Services may allow you to upload, submit, store, send, or receive content ("User Content"). You
                    retain ownership of any intellectual property rights that you hold in that User Content.
                  </p>
                  <p className="text-gray-300 mb-4">
                    By uploading, submitting, storing, sending, or receiving User Content through our Services, you
                    ...
                    such User Content for the limited purpose of providing and improving our Services.
                  </p>
                  <p className="text-gray-300">
                    You are solely responsible for your User Content and the consequences of sharing it. We are not
                    responsible for the content or accuracy of any User Content, and we have no obligation to monitor or
                    review any User Content.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    ...
                    <li>
                      Upload, transmit, or distribute any content that is illegal, harmful, threatening, abusive,
                    ...
                    <li>
                      Attempt to interfere with or disrupt the integrity or performance of our Services or the data
                      contained therein
                    </li>
                    <li>Circumvent any technological measure implemented by us to restrict access to our Services</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-4">
                    Our Services and all content and materials included on our Services, such as text, graphics, logos,
                    button icons, images, audio clips, digital downloads, data compilations, and software, are the
                    property of EduSphere AI or our licensors and are protected by copyright, trademark, and other
                    intellectual property laws.
                  </p>
                  <p className="text-gray-300">
                    We grant you a limited, non-exclusive, non-transferable, and revocable license to use our Services
                    for their intended purposes, subject to these Terms. You may not copy, modify, distribute, sell, or
                    lease any part of our Services or included content, nor may you reverse engineer or attempt to
                    extract the source code of our software, unless laws prohibit these restrictions or you have our
                    written permission.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    ...
                    ANY DEFECTS IN OUR SERVICES WILL BE CORRECTED. WE DO NOT WARRANT THAT THE RESULTS THAT MAY BE
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-4">
                    IN NO EVENT SHALL EDUSPHERE AI, ITS OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS, BE LIABLE TO YOU FOR
                    ...
                    OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF OUR SERVICES, (III) ANY
                    UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR
                    FINANCIAL INFORMATION STORED THEREIN, (IV) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM
                    OUR SERVICES, (V) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE, WHICH MAY BE TRANSMITTED TO OR
                    THROUGH OUR SERVICES BY ANY THIRD PARTY, AND/OR (VI) ANY ERRORS OR OMISSIONS IN ANY CONTENT OR FOR
                    ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF YOUR USE OF ANY CONTENT POSTED, EMAILED,
                    TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA OUR SERVICES, WHETHER BASED ON WARRANTY, CONTRACT,
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    You agree to defend, indemnify, and hold harmless EduSphere AI, its officers, directors, employees,
                    ...
                    access to our Services; (ii) your violation of any term of these Terms; (iii) your violation of any
                    third-party right, including without limitation any copyright, property, or privacy right; or (iv)
                    any claim that your User Content caused damage to a third party. This defense and indemnification
                    obligation will survive these Terms and your use of our Services.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    ...
                    to be invalid or unenforceable by a court, the remaining provisions of these Terms will remain in
                    effect.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    If you have any questions about these Terms, please contact us at legal@edusphereai.com.
                  </p>
                </div>

                <div className="pt-4 border-t border-gray-800">
                  <p className="text-gray-400 text-sm">Last Updated: June 1, 2023</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/licenses" className="text-gray-400 hover:text-white">
                    Licenses
                  </Link>
                </li>
              </ul>
