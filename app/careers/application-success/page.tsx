    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          ...
          <h1 className="text-3xl font-bold mb-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-transparent bg-clip-text">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/careers"
              className="px-6 py-3 rounded-md bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 transition-colors"
            >
              View More Positions
            </Link>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-black/50 backdrop-blur-sm border-t border-cyan-900/50">
