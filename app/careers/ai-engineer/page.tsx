        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-300">
              Join our team to build cutting-edge AI solutions that transform
          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                As an AI Engineer at EduSphere AI, you will be at the forefront
                of developing and implementing advanced AI models that power our
                educational platform. You will work on natural language
                processing, machine learning, and deep learning solutions to
                create intelligent features that help students learn more
                effectively. This role offers a unique opportunity to apply
                cutting-edge AI technologies to solve real-world educational
                challenges.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                <li>
                  Design, develop, and implement AI models for various features
                  including content summarization, question answering, and
                  personalized learning recommendations
                </li>
                <li>
                  Integrate with large language models (LLMs) like Gemini and
                  Hugging Face models to enhance our platform's capabilities
                </li>
                <li>
                ...
                <li>
                  Implement data pipelines for training, evaluating, and
                  deploying AI models
                </li>
                <li>
                  Develop and maintain documentation for AI systems and
                  processes
                </li>
                <li>
                  Mentor junior engineers and contribute to the growth of the AI
                  team
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                <li>
                  Bachelor's or Master's degree in Computer Science, AI, Machine
                  Learning, or a related field
                </li>
                <li>
                  3+ years of experience in developing and deploying AI/ML
                  models in production environments
                </li>
                <li>
                  Strong proficiency in Python and experience with AI/ML
                  frameworks such as TensorFlow, PyTorch, or Hugging Face
                  Transformers
                </li>
                <li>
                  Experience with natural language processing (NLP) and large
                ...
                <li>
                  Excellent communication skills and ability to explain complex
                  AI concepts to non-technical stakeholders
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                ...
                <li>
                  Experience with educational technology or learning systems
                </li>
