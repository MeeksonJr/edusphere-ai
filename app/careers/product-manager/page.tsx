export default function ProductManagerJobPage() {
  return (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-300">
              Help shape the future of education technology by leading our product development efforts.
            </p>
          </div>
          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                As a Product Manager at EduSphere AI, you will be responsible for driving the vision, strategy, and
                execution of our AI-powered educational platform. You will work closely with engineering, design, and
                business teams to identify opportunities, define requirements, and deliver features that delight our
                users and drive business growth. This is a unique opportunity to shape the future of education
                technology and make a meaningful impact on how students learn.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                <li>
                  Lead the product development lifecycle from ideation to launch, including market research, user
                  interviews, feature prioritization, and roadmap planning
                </li>
                <li>
                  Collaborate with engineering and design teams to define product requirements, create user stories, and
                  ensure successful implementation
                </li>
                <li>
                  Work with data analysts to establish metrics, track performance, and make data-driven decisions to
                  improve user experience and business outcomes
                </li>
                <li>
                  Conduct competitive analysis and stay up-to-date with industry trends in education technology and AI
                </li>
                <li>
                  Gather and synthesize user feedback to identify pain points and opportunities for product improvement
                </li>
                <li>
                  Communicate product vision, strategy, and roadmap to stakeholders across the organization and external
                  partners
                </li>
                <li>
                  Collaborate with marketing and sales teams to develop go-to-market strategies and product messaging
                </li>
                <li>
                  Prioritize features and enhancements based on user needs, business goals, and technical constraints
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                <li>
                  3+ years of experience in product management, preferably in education technology, SaaS, or consumer
                  applications
                </li>
                <li>
                  Strong understanding of product development methodologies, user-centered design, and agile practices
                </li>
                <li>
                  Experience working with cross-functional teams including engineering, design, data science, and
                  business stakeholders
                </li>
                <li>
                  Excellent analytical skills with the ability to translate data into actionable insights and product
                  decisions
                </li>
                <li>
                  Outstanding communication and presentation skills, with the ability to articulate complex concepts to
                  diverse audiences
                </li>
                <li>
                  Bachelor's degree in Computer Science, Business, or related field (or equivalent practical experience)
                </li>
                <li>Proven track record of shipping successful products or features</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                <li>Experience with AI/ML products or educational technology</li>
                <li>Background in education, teaching, or learning sciences</li>
                <li>Technical background or experience working with developers</li>
                <li>Experience with product analytics tools (e.g., Amplitude, Mixpanel)</li>
                <li>MBA or advanced degree in a relevant field</li>
                <li>Experience with user research methodologies and tools</li>
              </ul>
            </section>
