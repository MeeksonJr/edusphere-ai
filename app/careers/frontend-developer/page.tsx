        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-300">
              Help us build beautiful, responsive, and accessible user interfaces for our AI-powered education platform.
            </p>
          </div>
          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                As a Frontend Developer at EduSphere AI, you will be responsible for implementing visually stunning and
                highly functional user interfaces that bring our AI-powered education platform to life. You will work
                closely with designers, backend developers, and product managers to create intuitive and responsive web
                applications that help students learn more effectively. This role offers an exciting opportunity to work
                with cutting-edge technologies and make a meaningful impact on education.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                <li>
                  Develop and maintain responsive, accessible, and performant web applications using React, Next.js, and
                  TypeScript
                </li>
                <li>Implement UI designs with pixel-perfect accuracy using Tailwind CSS and modern CSS techniques</li>
                <li>Create smooth animations and transitions using Framer Motion to enhance user experience</li>
                <li>Collaborate with backend developers to integrate frontend applications with APIs and services</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                <li>3+ years of experience in frontend development with React</li>
                <li>Strong proficiency in JavaScript/TypeScript, HTML, and CSS</li>
                <li>Experience with Next.js and server-side rendering</li>
                <li>Familiarity with Tailwind CSS or similar utility-first CSS frameworks</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                <li>Experience with animation libraries like Framer Motion or GSAP</li>
                <li>Knowledge of state management libraries (Redux, Zustand, Jotai)</li>
