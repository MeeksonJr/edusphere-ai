          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Choose the plan that's right for you and start boosting your
                academic performance today.
              </p>

              <div className="flex items-center justify-center mb-12">
                <span
                  className={`mr-2 ${!annual ? "text-white" : "text-gray-400"}`}
                >
                  Monthly
                </span>
                <Switch
                ...
                />
                <span
                  className={`ml-2 ${annual ? "text-white" : "text-gray-400"}`}
                >
                  Annual
                </span>
                <Badge className="ml-2 bg-green-900 text-green-300 border-green-700">
                  Save 20%
                </Badge>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <Card className="glass-card relative overflow-hidden border-purple-600">
                <div className="absolute top-0 right-0">
                  <Badge className="rounded-tl-none rounded-br-none bg-purple-600 text-white">
                    Popular
                  </Badge>
                </div>
                <CardHeader>
              ...
              <div className="space-y-6">
                <div className="glass-card p-6">
                  ...
                  <p className="text-gray-400">
                    ...
                    you upgrade, the new pricing will take effect immediately.
                    If you downgrade, the new pricing will take effect at the
                ...
                <div className="glass-card p-6">
                  <h3 className="text-xl font-bold mb-2">
                    How does the AI request limit work?
                  </h3>
                  <p className="text-gray-400">
                    Free users get 10 AI requests per month. These requests
                    reset on the first day of each month. Pro and Ultimate users
                    get unlimited AI requests, allowing them to fully leverage
                    our AI capabilities without restrictions.
                  </p>
                </div>
                ...
                <div className="glass-card p-6">
                  ...
                  <p className="text-gray-400">
                    Yes! We offer a 20% discount for students with a valid .edu
                    email address. Contact our support team after signing up to
                    verify your student status and receive the discount.
                  </p>
                </div>
                ...
                <div className="glass-card p-6">
                  ...
                  <p className="text-gray-400">
                    We offer a 7-day free trial for both our Pro and Ultimate
                    plans. You can cancel anytime during the trial period and
                    won't be charged.
                  </p>
                </div>
                ...
                <div className="glass-card p-6">
                  ...
                  <p className="text-gray-400">
                    ...
                    Express, Discover) as well as PayPal. All payments are
