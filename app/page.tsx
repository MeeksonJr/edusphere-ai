        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 flex flex-col items-center justify-between border-t border-purple-900/20 pt-8 md:flex-row">
            ...
            <div className="mt-4 flex space-x-6 md:mt-0">
              <a href="https://www.facebook.com/profile.php?id=100011003917426" className="text-gray-400 hover:text-purple-500">
              ...
              <a href="https://www.instagram.com/md_meekson_jr/" className="text-gray-400 hover:text-purple-500">
              ...
              <a href="https://github.com/MeeksonJr" className="text-gray-400 hover:text-purple-500">
