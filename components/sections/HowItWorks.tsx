            ...
            <div className="glass-surface p-4 rounded-lg mt-4">
                <div className="flex items-center gap-3">
                    ...
                    <div className="h-10 px-4 rounded-lg bg-cyan-500/20 border border-cyan-500/30 flex items-center">
                        <span className="text-xs text-cyan-300 font-medium">Generate</span>
                    </div>
                </div>
            </div>
        ),
            ...
            <div className="max-w-5xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 relative">
                    ...
                    <div className="hidden md:block absolute top-[72px] left-[16.5%] right-[16.5%] h-[2px]">
                        <div className="h-full bg-gradient-to-r from-cyan-500/40 via-cyan-500/40 to-amber-500/40 rounded-full" />
                    </div>
